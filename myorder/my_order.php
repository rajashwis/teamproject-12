...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="my_order.css">
...
<body>
    <div class="home-page">
      ...
      <div class="Order-item">
        ...
        <div class="Order">
          <div><img src="croissants.jpg" alt="Order Image"></div>
          <div>
        ...
        <div class="Order Number">5202</div>
      ...
      <div class="Order-item">
        <div class="Order">
          <div><img src="Cake.jpg" alt="Order Image"></div>
          <div>
            <div class="Order-info">
              <p>Cake</p>
            </div>
      ...
      <div class="Order-item">
        <div class="Order">
          <div><img src="avocado.jpg" alt="Order Image"></div>
          <div>
            <div class="Order-info">
              <p>Avocado</p>
            </div>
