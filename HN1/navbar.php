...
.image-container {
    flex: 1; /* Flexible image container */
...
.card button {
    ...
    font-size: 18px;
    border-radius: 20px;
    margin: 20px auto 0; /* Adjusted margins */
}
        ...
        <div class="navbar2" id="nav2">
            <nav>
                <ul>
                    ...
                    <li><a href=""> FASHION</a></li>
                    <li><a href=""> SALES</a></li>
                    <li class="bs-split"><a href="trader.html"> BECOME A SELLER</a></li>
                </ul>
