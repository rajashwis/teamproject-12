        ...
        <div class="main">
            ...
            <section class="shop">
                ...
                <div class="filters">
                    ...
                    <?php
                        ...
                        while($shop = oci_fetch_assoc($statement1)) {
                            $checked = [];
                            ...
                            <label><input type="checkbox" name="shop[]" value="<?php echo $shop['SHOP_ID']; ?>" <?php if(in_array($shop['SHOP_ID'], $checked)) { echo "checked"; } ?>> 
            ...
            <div class="image-container-group">
                ...
                if($shopchecked) {
                    ...
                    $shop_list = implode(",", array_map('intval', $shopchecked));

                    $query1 = "SELECT * FROM PRODUCT WHERE SHOP_ID IN ($shop_list) ORDER BY $sort_product";
                    $statement1 = oci_parse($connection, $query1);
                    oci_execute($statement1);
